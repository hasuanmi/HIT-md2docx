---
name: hit-audit
description: 绑定自查知识库，逐条检查行距、缩进、参考文献、页码、图表格编号等可机检项，输出 JSON 违规清单。在 HIT-md2docx 流程的第 4 步调用。
---

# 规范校验 Skill（步骤 4）

对生成的 docx 执行机检，逐条对照 `skill/references/selfcheck-checklist.md`（对应 `skill/scripts/format_rules.py` 的 R01–R11）。
...
## 参考
- `skill/references/selfcheck-checklist.md` · `skill/references/hit-master-review-points.md` · `skill/scripts/format_rules.py`
