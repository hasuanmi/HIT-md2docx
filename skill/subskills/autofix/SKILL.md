---
name: hit-autofix
description: 批量修正可自动修复的格式问题（R01/R02/R05/R06 等幂等修复），并更新目录域。在 HIT-md2docx 流程的第 5 步调用。
---
...
## 参考
- `skill/scripts/format_rules.py` · `skill/scripts/fix_docx.py`
